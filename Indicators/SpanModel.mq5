...
#property indicator_label8  "②遅行スパン (1=陽転 -1=陰転 0=絡む)"
#property indicator_type8   DRAW_NONE
#property indicator_label9  "③終値と青スパン (1=上 -1=下)"
#property indicator_type9   DRAW_NONE
#property indicator_label10 "④赤スパンの傾き (1=上 -1=下 0=平ら・平らも通す)"
...
double BufC1[], BufC2[], BufC3[], BufC4[];
...
int OnInit()
{
   ...
   SetIndexBuffer(8,  BufC2,     INDICATOR_DATA);
   SetIndexBuffer(9,  BufC3,     INDICATOR_DATA);
   SetIndexBuffer(10, BufC4,     INDICATOR_DATA);
